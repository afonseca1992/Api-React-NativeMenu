...
export default class BuscarSuper extends Component {
    ...
    render(){
      ...
      if(this.state.done !== true){
        return (
          ...
          <Image resizeMode="contain" style={styles.formatoImagen} source={require('../assets/super.gif')}/>
        ...
        return (
          <View style={styles.container}>
            <Image resizeMode="contain" style={styles.formatoImagen2} source={require('../assets/superheroes02.jpg')}/>
